        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Grades_MarksObtained_Valid", "[MarksObtained] >= 0 AND [MarksObtained] <= [TotalMarks]");
                    table.CheckConstraint("CK_Grades_TotalMarks_Positive", "[TotalMarks] > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_Student_Subject_Date_Unique",
                table: "Attendances",
                columns: new[] { "StudentEnrollmentId", "SubjectId", "Date" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Grades_Student_Subject_ExamType",
                table: "Grades",
                columns: new[] { "StudentEnrollmentId", "SubjectId", "ExamType" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentEnrollments_RollNumber",
                table: "StudentEnrollments",
                column: "RollNumber",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subjects_Code_ClassId",
                table: "Subjects",
                columns: new[] { "Code", "ClassId" },
                unique: true);
